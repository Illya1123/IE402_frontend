        ...
        <div className="flex pt-[125px] h-[2000px]">
            ...
            <div className="w-2/3 h-full flex-1 text-start text-xl space-y-5 ">
                <div className="py-3 mr-10 bg-white shadow rounded-lg">
                    <h2 className="ml-2 text-2xl font-semibold">Danh sách tour đã đặt</h2>
                ...
                <div className="flex mb-5">
                    <button
                        ...
                        isDone ? "bg-blue-500 text-white" : "bg-gray-200 text-black"
                ...
                <div className="mr-10 flex-grow">
                    {
                        isDone && DataDone.length > 0 ? (
                            DataDone.map((destination) => (                                
                                <TouristCard item={destination} type={"Cart-Done"}></TouristCard>
                            )) 
                        ) : (
                            DataOnProcess.length > 0 ? (
                                DataOnProcess.map((destination) => (
                                    <TouristCard key={destination.id} item={destination} type={"Cart-On-Process"} />
                                ))
                            ) : (
                                <p>Loading...</p>
                            )
